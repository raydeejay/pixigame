...
//>>excludeEnd("imports");
, "amber-pixigame/Pixi-Engine"], function($boot
//>>excludeStart("imports", pragmas.excludeImports);
,PIXI
//>>excludeEnd("imports");
){"use strict";
...
return $globals.Pixigame;

},
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "game\x0a\x09^ Pixigame",
...
if($core.assert($1)){
$recv($recv($self._game())._instance())._lose();
}
return self;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "update\x0a\x09self move.\x0a\x09(self class at: #dungeon) contain: self.\x0a\x09(self health < 0) ifTrue: [ self game instance lose ]",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["move", "contain:", "at:", "class", "ifTrue:", "<", "health", "lose", "instance", "game"]
}),
$globals.Explorer);
...
if($core.assert($3)){
$recv($recv($self._game())._instance())._win();
}
return self;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "update\x0a\x09| explorer |\x0a\x09\x0a\x09explorer := self class at: #explorer.\x0a\x09(explorer hits: self) ifTrue: [ self follow: explorer ].\x0a\x09(self hits: (self class at: #door)) ifTrue: [ self game instance win ]",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["at:", "class", "ifTrue:", "hits:", "follow:", "win", "instance", "game"]
}),
$globals.Treasure);
